...
export FREQTRADE__EXCHANGE__NAME="${EXCHANGE_NAME}"
export FREQTRADE__EXCHANGE__KEY="${EXCHANGE_API_KEY}"
export FREQTRADE__EXCHANGE__SECRET="${EXCHANGE_API_SECRET}"
export FREQTRADE__EXCHANGE__PASSWORD="${EXCHANGE_API_PASSWORD}"
